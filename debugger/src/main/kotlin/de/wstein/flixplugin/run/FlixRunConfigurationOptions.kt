 ...
 * [de.wstein.flixplugin.FlixJar] -- so a saved configuration keeps working after the fork is
...
class FlixRunConfigurationOptions : LocatableRunConfigurationOptions() {
     ...
     *
     * Held as the raw string the user typed; [de.wstein.flixplugin.FlixLaunchCommand] normalises it
