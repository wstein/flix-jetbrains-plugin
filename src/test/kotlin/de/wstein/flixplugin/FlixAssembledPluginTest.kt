...
class FlixAssembledPluginTest : BasePlatformTestCase() {
    ...
    fun testTheDebuggerModuleFollowsTheJavaPlugin() {
        ...
        val ours = registered.any { it == "de.wstein.flixplugin.debugger.FlixPositionManagerFactory" }
    ...
    fun testTheFlixRunConfigurationTypeIsAvailable() {
        ...
        assertTrue(
            ...
            types.any { it == "de.wstein.flixplugin.run.FlixRunConfigurationType" },
        )
    }
    ...
    private companion object {
        private const val PLUGIN_ID = "de.wstein.flix-jetbrains-plugin"
    }
}
